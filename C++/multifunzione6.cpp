...
int main()
{
    int s, n, numero, t, d, rd, d2, anno,  anno_corrennte, a=0, b=0, c=0, d3=0, e=0, f=0, nt, ft, tot,num2, fattoriale=1, i, nc;
    float rq=0, num, rn=0, base, credito, credito2, credito4, credito6, credito8, credito10, nva, nva2;
...
int Menu()
{
    ...
    cout<<"10. CALCOLO VALORE ASSOLUTO"<<endl;
    cout<<"0. USCITA"<<endl;
    cin>>s;
    return s;
    cout<<" "<<endl;
...
void Casuale()
{
	...
	cout<<" "<<endl;
	cout<<"inserisci il numero intero minimo dell' intervallo dei numeri casuali"<<endl;
	cin>>nc;
	cout<<" "<<endl;
	cout<<"inserisci il numero intero massimo dell' intervallo dei numeri casuali"<<endl;
	cin>>n;
	
	if(n<nc)
	{
		cout<<" "<<endl;
		cout<<"e' impossibile generare un numero casuale perche' il numero che dovrebbe essere piu' grande e' piu' piccolo"<<endl;
		cout<<" "<<endl;
	}
	else
	{
...
void Valore_assoluto()
{
	float nva, nva2;
	cout<<" "<<endl;
	cout<<"inserisci il numero di cui voglio calcolare il valore assoluto"<<endl;
	cin>>nva;
	...
	if(nva>0)
	{
		nva2=nva;
		cout<<" "<<endl;
		cout<<"il valore assoluto di "<<nva<<" e' "<<nva2<<endl;
		cout<<" "<<endl;
	}
	else
	{
