...
void Casuale()
{
	...
	cout<<" "<<endl;
	cout<<"inserisci da che numero vuoi generare un numero casuale"<<endl;
	cin>>nc;
	cout<<" "<<endl;
...
void Tabelline()
{
	...
	cin>>nt;
	cout<<" "<<endl;
	cout<<"inserisci fino a che numero vuoi fare la tabellina"<<endl;
	cin>>ft;
	cout<<" "<<endl;
...
void Valore_assoluto()
{
	float nva, nva2;
	cout<<" "<<endl;
	cout<<"inserisci il numero da calcolare il valore assoluto"<<endl;
	cin>>nva;
