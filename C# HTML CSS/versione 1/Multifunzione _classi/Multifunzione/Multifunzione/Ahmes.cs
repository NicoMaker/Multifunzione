    ...
    public static int Visualizza(int numero1, int numero2)
    {
        ...
        while (numero1 > 0)
        {
            ...
            else
            {
                ...
                Console.WriteLine(resto == 0 ? $"{passaggio} passaggio visto che {numero1} è dispari allora --> ({numero1} - 1) * ({numero2} + {numero2})" : $"{passaggio} passaggio se {numero1} è dispari allora --> ({numero1} - 1) * ({numero2} + {resto})");
